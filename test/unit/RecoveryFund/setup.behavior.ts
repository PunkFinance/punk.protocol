...
export function setUpBehavior(): void {
    context("SetUp", function() {
        ...
        it('should Success Refund', async function() {
            ...
            const refundTx = (await recoveryFundMock.connect(accountDai).refund(balance)).toString();
            ...
            await expect( await recoveryFundMock.balanceOf("0x8ed32Ed24303092c016Cdb24d51e153AD88c4875")).eq( BigNumber.from("89858957570000000000000").sub(BigNumber.from("89858957570000000000000").mul(balance).div(beforeTotalSupply)));
