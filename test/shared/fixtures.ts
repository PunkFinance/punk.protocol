...
export async function unitFixtureVariables([
  owner,
]: Wallet[]): Promise<Contract> {
...
export async function unitFixtureAaveModel(): Promise<Contract> {
  const AaveModel = await ethers.getContractFactory("AaveModel");
...
export async function unitFixtureOwnableStorage([
  ,
  ,
  ,
  ,
